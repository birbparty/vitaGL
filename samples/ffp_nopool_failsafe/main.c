...
//   3) ux0:data/ffp_nopool_results.txt, for headless / post-mortem inspection.
...
static void crumb(const char *msg) {
	SceUID f = sceIoOpen("ux0:data/ffp_nopool_progress.txt",
...
static void write_results(void) {
	SceUID f = sceIoOpen("ux0:data/ffp_nopool_results.txt",
...
int main(void) {
	...
	sceIoRemove("ux0:data/ffp_nopool_progress.txt");
